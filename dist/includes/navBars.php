          ...
          <div id="sidebar" class="sidebar sidebar-with-footer">
            ...
            <div class="app-brand">
              <a href="./index.php"title="Yogouslavie">
                ...
                <span class="brand-name text-truncate" > YOUGOSLAVIE </span>
              </a>
            </div>
          ...
          <header class="main-header " id="header">
            <nav class="navbar navbar-static-top navbar-expand-lg">
              ...
              <div class="search-form  d-lg-inline-block">
                 ...
                 <h2><marquee behavior="" direction="">YOUGOSLAVIE</marquee></h2>
                ...
                <ul class="nav navbar-nav">
                  ...
                  <li class="dropdown user-menu">
                    <button href="#" class="dropdown-toggle nav-link" data-toggle="dropdown">
                      <img src="assets/img/user/u6.jpg" class="user-image" alt="User Image" />
                      <span class="d-none d-lg-inline-block">Dal99cir</span>
                    </button>
                    <ul class="dropdown-menu dropdown-menu-right">
                      <!-- User image -->
                      <li class="dropdown-header">
                        <img src="assets/img/user/u6.jpg" class="img-circle" alt="User Image" />
                      ...
                      <li class="dropdown-footer">
                        <a href="index.html"> <i class="mdi mdi-logout"></i>Quitter </a>
                      </li>
                    </ul>
                  </li>
                </ul>
